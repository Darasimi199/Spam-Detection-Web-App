...
model = pickle.load(open(r"C:\Users\Darasimi199\Documents\ML_Projects\spam\SVM_model.pkl", 'rb'))

def main():
    st.title('Message Detection Solution')

    #load in the dataset
    df = pd.read_csv(r'C:\Users\Darasimi199\Documents\ML_Projects\spam\clean_df.csv')
